...
public abstract interface WorkflowEngine
{
  ...
  public abstract List<WfAction> getAvailableActions(String paramString1, String paramString2, String paramString3, String paramString4, Map<String, DataField> paramMap)
    throws WorkflowException;
 ...
 * Qualified Name:     com.ultrapower.workflow.engine.core.WorkflowEngine
