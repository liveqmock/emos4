...
package com.ultrapower.eoms.common.core.component.rule.function.string;

import com.ultrapower.eoms.common.core.component.rule.RuleConstants;
import com.ultrapower.eoms.common.core.component.rule.RuleEngine;
...
import com.ultrapower.eoms.common.core.component.rule.function.FunctionHelper;
...
public class ToUpperCase implements Function {
	 ...
	 */
	public FunctionResult execute( final String arguments)
		...
		try {
			...
			String argumentOne = FunctionHelper.trimAndRemoveQuoteChars(
					stringValue, RuleConstants.SINGLE_QUOTE);
