 ...
 */
@Entity
@Table(name = "BS_T_SM_SMSORDERFORM")
public class SmsOrderForm implements java.io.Serializable {

	// Fields

	private static final long serialVersionUID = -7463031258057773754L;
	private String pid;
	...
	/** minimal constructor */
	public SmsOrderForm(String pid) {
		this.pid = pid;
	}

	/** full constructor */
	public SmsOrderForm(String pid, String formschema, String formaction,
			String loginname, String usermobile, Long isholiday,
			String starttime, String endtime, Long status, String lastmodifier,
			Long lastmodifytime) {
		this.pid = pid;
	...
	@Column(name = "FORMSCHEMA", unique = false, nullable = true, insertable = true, updatable = true, length = 80)
	...
	@Column(name = "FORMACTION", unique = false, nullable = true, insertable = true, updatable = true, length = 30)
