 ...
 */
@Entity
@Table(name="BS_T_SM_SMSMONITOR")
public class Smsmonitor  implements java.io.Serializable {


    // Fields

	 private static final long serialVersionUID = -3129603712861000973L;
	 private String pid;
     ...
     private int sendnum;
     private long firstsendtime;//第一次发送时间 
	...
	/** minimal constructor */
    public Smsmonitor(String pid) {
        this.pid = pid;
    }
    
    /** full constructor */
    public Smsmonitor(String pid, String content, String systemtype, String goal, int sendflag, long presendtime, String relateid, String gatewaycode, String gatewaycribe, int sendnum, long firstsendtime, long sendtime, int pri, long infoinputtime, String rematk) {
        this.pid = pid;
