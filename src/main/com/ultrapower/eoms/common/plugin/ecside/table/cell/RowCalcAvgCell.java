...
import com.ultrapower.eoms.common.plugin.ecside.view.html.ColumnBuilder;
...
public class RowCalcAvgCell implements Cell  {
    ...
    protected String getCellValue(TableModel model, Column column) {
        ...
        column.setValue(new BigDecimal(totalValue/num));
