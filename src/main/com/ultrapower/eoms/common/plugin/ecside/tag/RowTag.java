...
//       	 if (!isExported || isPrint ) {	
		          ...
		          row.setSelectlightClass(TagUtils.evaluateExpressionAsString("selectlightClass", this.selectlightClass, this, pageContext));
		          row.setSelectlightRow(TagUtils.evaluateExpressionAsBoolean("selectlightRow", this.selectlightRow, this, pageContext));
//        		}
