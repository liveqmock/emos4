...
public class SaveTool extends BaseTool {
    ...
    public String getToolAction() {
    	...
    	StringBuffer action = new StringBuffer(ECSideConstants.UTIL_FUNCTION_NAME);

        
        action.append(".saveGird(this, '"+formId+"',").append(getTableModel().getTable().isBatchUpdate()).append(");");
