...
//	        int totalCol=model.getColumnHandler().getColumns().size();
	        ...
	        rownum+=createRow(sheet, getRows(extendRowBefore,encoding),WritableWorkbook.NORMAL_STYLE, rownum,0)-1;
...
//            int totalCol=model.getColumnHandler().getColumns().size();
            ...
            rownum+=createRow(sheet, getRows(extendRowAfter,encoding),WritableWorkbook.NORMAL_STYLE, rownum,0);
