	...
	<table width="100%" cellspacing="0" cellpadding="0" border="0" class="list_table hasthbg" id="tab">
		...
		%>
			...
			<select class='paddingHack' id='var_currentpage'
				name='var_currentpage' onchange="return tranferPageDealed('go')">
				<%
			...
			<select class='paddingHack' id='var_pagesize' name='var_pagesize'
				onchange="return tranferPageDealed('setsize')">
			...
			条&nbsp;
               ...
               <div class="page">
                <span>
                <a href="javascript:;" onclick="return tranferPageDealed('frist')" target="_self">第一页&nbsp;</a>
			<a href="javascript:;" onclick="return tranferPageDealed('previous')"
				target="_self"> &nbsp; 上一页 </a>
			&nbsp;&nbsp;
			<a href="javascript:;" onclick="return tranferPageDealed('next')" target="_self">下一页 </a>
			<a href="javascript:;" onclick="return tranferPageDealed('last')"
				target="_self"> &nbsp;最后页&nbsp;</a>
                </span>
                </div>
              </div>
...
<script type="text/javascript" >
  ...
  /**
	 ...
	 */
	 ...
	 function tranferPageDealed(type) 
	 {	
