	...
	<body style="overflow: hidden;">
		<div class="content">
			...
			<div style="overflow: hidden;" id="center">
				<iframe src="${ctx}/common/tools/typeItemTree.jsp?sortType=<%=sortType%>&isRadio=<%=isRadio%>&dtcode=<%=dtcode%>" id='tree' scrolling="no" frameborder="0" width="100%" height="100%"></iframe>
			</div>
