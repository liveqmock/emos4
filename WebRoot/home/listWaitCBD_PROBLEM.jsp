...
<html>
  ...
  <body style="background-color:white;">
	  	<dg:datagrid  var="waitingdealsheet"   title="${nodePath}" action="" sqlname="SQL_WF_WaitingDealSheetProblem.query" tquery="true">
	  		<dg:lefttoolbar>
	    ...
	    <dg:gridtitle>
		    	<tr>
		    		...
		    		<th width="20%" field="worksheettitle"><eoms:lable name="主题"/></th>
