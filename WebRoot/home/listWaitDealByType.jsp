...
// 		  setCenter(0,55);
	   ...
	   */
	   function excelExport(){
	   	 document.forms[0].action="sheetExport.action?type=${queryname}";
  ...
  <body style="background-color:white;">
	    ...
	    <dg:gridtitle>
		    	<tr>
		    		<th width="5%" field="serialnum"><eoms:lable name="wf_sheet_serialnum"/></th>
		    		<th width="20%" field="serialnum"><eoms:lable name="主题"/></th>
		    		<th width="3%" field="dealer"><eoms:lable name="wf_sheet_dearuser"/></th>
		...
		<dg:gridrow>
			<tr class="${viplevel eq '' ? '' : 'vip'}">
		        ...
		        <td><a title="${basesummary}" href="javascript:;" onclick="openSheet('${baseschema}','${baseid}','${taskid}','${processtype}');">${basesummary}</a></td>
		        <td style="text-align:center;"><a title="${deal}" href="javascript:;" onclick="openSheet('${baseschema}','${baseid}','${taskid}','${processtype}');">${deal}</td>
		        <td style="text-align:center;"><a href="javascript:;" onclick="openSheet('${baseschema}','${baseid}','${taskid}','${processtype}');"><eoms:date value="${basecreatedate}"/></a></td>
