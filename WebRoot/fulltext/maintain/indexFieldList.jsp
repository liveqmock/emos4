...
<html>
  <head> 
	...
	<script language="javascript">
		...
		function categoryDel()
		{
			...
			{
				document.forms[0].action = "${ctx}/indexFieldManager/delField.action";
  ...
  <body> 
  	<dg:datagrid  var="field" title="${nodePath}" action="" sqlname="SQL_FTR_IndexFieldList.query">
  		<dg:lefttoolbar>
  		  ...
  		  <eoms:operate cssclass="page_add_button" id="com_btn_add" onmouseover="this.className='page_add_button_hover'" 
  		      ...
  		      onclick="openwindow('${ctx}/indexFieldManager/fieldLoad.action','',800,450);"
    	...
    	<dg:gridtitle>
	    	<tr>
	    		...
	    		<th><eoms:lable name="ftr_lb_indexCategoryName"/></th>
	    		<th><eoms:lable name="ftr_lb_fieldName"/></th>
	    		<th width="10%"><eoms:lable name="ftr_lb_isStore"/></th>
	    		<th width="10%"><eoms:lable name="ftr_lb_isIndex"/></th>
	    		<th width="10%"><eoms:lable name="ftr_lb_isAnalyze"/></th>
	    		<th width="10%"><eoms:lable name="ftr_lb_isDisplay"/></th>
	    		<th width="10%"><eoms:lable name="ftr_lb_isTitle"/></th>
	    		<th width="10%"><eoms:lable name="ftr_lb_sourceType"/></th>
	    	</tr>
    	</dg:gridtitle> 
		<dg:gridrow>
			<tr class="${field_row}">
				<td><input name="checkid" type="checkbox" value='${pid}'></input></td>
		        <td><a href="javascript:;" onclick="openwindow('${ctx}/indexFieldManager/fieldLoad.action?pid=${pid}','',800,450);">${categoryname}</a></td>
		        <td><a href="javascript:;" onclick="openwindow('${ctx}/indexFieldManager/fieldLoad.action?pid=${pid}','',800,450);">${fieldname}</a></td>
		        <td>
			        <a href="javascript:;" onclick="openwindow('${ctx}/indexFieldManager/fieldLoad.action?pid=${pid}','',800,450);">
			        	<eoms:dic value="${isstore}" dictype="isdefault"></eoms:dic>
			        </a>
		        </td>
		        <td>
			        <a href="javascript:;" onclick="openwindow('${ctx}/indexFieldManager/fieldLoad.action?pid=${pid}','',800,450);">
			        	<eoms:dic value="${isindex}" dictype="isdefault"></eoms:dic>
			        </a>
		        </td>
		        <td>
			        <a href="javascript:;" onclick="openwindow('${ctx}/indexFieldManager/fieldLoad.action?pid=${pid}','',800,450);">
			        	<eoms:dic value="${isanalyze}" dictype="isdefault"></eoms:dic>
			        </a>
		        </td>
		        <td>
			        <a href="javascript:;" onclick="openwindow('${ctx}/indexFieldManager/fieldLoad.action?pid=${pid}','',800,450);">
			        	<eoms:dic value="${isdisplay}" dictype="isdefault"></eoms:dic>
			        </a>
		        </td>
		        <td>
			        <a href="javascript:;" onclick="openwindow('${ctx}/indexFieldManager/fieldLoad.action?pid=${pid}','',800,450);">
			        	<eoms:dic value="${istitle}" dictype="isdefault"></eoms:dic>
			        </a>
		        </td>
		        <td>
			        <a href="javascript:;" onclick="openwindow('${ctx}/indexFieldManager/fieldLoad.action?pid=${pid}','',800,450);">
			        	<eoms:dic value="${sourcetype}" dictype="FTRSourceType"></eoms:dic>
			        </a>
		        </td>
		    </tr>
		</dg:gridrow>
