...
<%@ page import="com.ultrapower.eoms.fulltext.dao.ManualFileDao" %>
<%@ page import="com.ultrapower.eoms.fulltext.model.ManualFile" %>
...
<%
	...
	if(pid!=null)
	{
		ManualFileDao mfd = new ManualFileDao();
		ManualFile mf = mfd.getByPid(pid);
		if(mf!=null)
		{
			path = mf.getStorepath();
		}
	}
	if(path!=null)
	{
