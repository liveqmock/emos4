...
<html>
	...
	function addField()
	{
		...
		if(selObjWorksheet.selectedIndex != -1)
		{
			var idFieldType = selObjWorksheet.options[selObjWorksheet.selectedIndex].value;//返回下拉列表中被选选项的文本
			var label = selObjWorksheet.options[selObjWorksheet.selectedIndex].text;//返回下拉列表中被选选项的值
			
			selObjWorksheet.remove(selObjWorksheet.selectedIndex);
	...
	{
		var selObjStep = document.getElementById("stepFieldSl");
		if(selObjStep.selectedIndex!=-1)
		{
			var idFieldType = selObjStep.options[selObjStep.selectedIndex].value;//返回下拉列表中被选选项的文本
			var label = selObjStep.options[selObjStep.selectedIndex].text;//返回下拉列表中被选选项的值
			
			selObjStep.remove(selObjStep.selectedIndex);
	...
	<body>
	 	<s:form action="saveConfigStepField.action" theme="simple" name="fieldForm" id="fieldForm" method="post" target="_self">
		...
		<div class="content">
			<div class="title_right">
				<div class="title_left">
					<span class="title_bg"> <span class="title_icon2"> <eoms:lable name="bpp_develop_fix_no"/> </span> </span>
				...
				<table style="width: 100%; heigth: 280px">
					...
					<tr>
						<td style="width: 40%; height: 250px">
							<s:select name="baseFieldSl" id="baseFieldSl" list="baseFieldList" cssStyle="width:98%;height:250px" cssClass="select" listKey="id" listValue="label" multiple="true"></s:select>
						</td>
						<td width="50">
						...
						<td width="50%">
							<s:select name="stepFieldSl" id="stepFieldSl" list="stepFieldRelationList" cssStyle="width:98%;height:250px" cssClass="select" listKey="baseField.id" listValue="baseField.label" multiple="true"></s:select>
						</td>
					</tr>
				</table>
			</div>
