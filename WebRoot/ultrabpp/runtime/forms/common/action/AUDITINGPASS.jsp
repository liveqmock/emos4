...
<div id="RollbackTable1_ubfbox" class="bpp_Field bpp_RollbackListField" style="width:960px;">
	<table border="0" cellpadding="0" cellspacing="0" style="width:950px; height:30px;">
		<tr>
			<td valign="center" colspan="2"><div><span style="font-size:14px; font-weight:bold; color:green;">审批通过！</span></div></td>
		</tr>
	</table>
</div>
...
ClientContext.submit("action", "AUDITINGPASS", function()
{
	var Desc = F("Desc").G();
