...
<ubf:AssignTreeField name="dealPerson" label="处理人" row="1" cell="1" single="1"  stepno="step03" selectType="2"  actionName="ToAudit" next="1" visiable="1" />
<ubf:CharacterField name="audit_info" label="审批意见" row="5" cell="4" visiable="1" length="1000" />
