...
<ubf:CharacterField name="AuditDesc" label="审批意见" row="3" cell="4" visiable="1" length="3000" />
...
<ubf:AssignTreeField name="auditAgainUser" label="审批人" row="1" cell="1" single="1" action="RENEXT" stepno="step_4" selectType="2"  actionName="AuditPass" next="1" visiable="1" />
<ubf:CharacterField name="step_sug" label="审批意见" row="3" cell="4" visiable="1" length="4000" />
