...
<ubf:AssignTreeField name="auditAgainUser" label="审批人" row="1" cell="1" single="1" action="RENEXT" stepno="step_4" selectType="2"  actionName="auditPassed" next="1" visiable="1" />
