...
<div id="bpp_FormContainer">
	<div id="bpp_Header">
		<div id="bpp_BaseStatus">
			<div id="bpp_BaseStatus_begin"></div>
			<div id="bpp_BaseStatus_font"><c:choose><c:when test="${displayCxt.editType=='MODIFY'}">${displayCxt.fieldMap['BASESTATUS']}</c:when><c:otherwise>草稿</c:otherwise></c:choose></div>
			<div id="bpp_BaseStatus_end"></div>
		</div>
		...
		<div id="bpp_BasicInfor">
			<span id="bpp_CreateUser">建单人：<font>${displayCxt.fieldMap['BASECREATORFULLNAME']}</font></span>
			<span id="bpp_CreateDep">建单人部门：<font>${displayCxt.fieldMap['BASECREATORDEP']}</font></span>
			<span id="bpp_CreateTime">建单时间：<font><eoms:date value="${displayCxt.fieldMap['BASECREATEDATE']}"></eoms:date></font></span>
			<span id="bpp_FinishTime">完成时间：<font><eoms:date value="${displayCxt.fieldMap['BASEFINISHDATE']}"></eoms:date></font></span>
			<span id="bpp_CloseTime">关闭时间：<font><eoms:date value="${displayCxt.fieldMap['BASECLOSEDATE']}"></eoms:date></font></span>
		</div>
	</div>
	<div id="bpp_TaskInfor">
		<div id="bpp_TaskName"><span>处理描述：<font>${displayCxt.currentTask.taskName}</font></span></div>
		<div>
			<span id="bpp_TaskStatus">任务状态：<font>${displayCxt.currentTask.processState}</font></span>
			<span id="bpp_TaskCreateTime">开始时间：<font><eoms:date value="${displayCxt.currentTask.createTime}"></eoms:date></font></span>
			<span id="bpp_TaskAcceptDeadLine">受理时限：<font><eoms:date value="${displayCxt.currentTask.acceptDate}"></eoms:date></font></span>
			<span id="bpp_TaskDealDeadLine">处理时限：<font><eoms:date value="${displayCxt.currentTask.dueDate}"></eoms:date></font></span>
		</div>
	</div>
	<div id="bpp_Body">
