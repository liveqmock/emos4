  ...
  <body>
  	<div class="content">
		<div class="page_div_bg">
			<table style="height:100%"><tr valign="bottom"><td>交接班信息查询数</td></tr></table>
		</div>
		...
		<script type="text/javascript">
			...
			tree.setXMLAutoLoading("${ctx}/dutyOrgLevel/dutyLogTree.action");
			tree.loadXML("${ctx}/dutyOrgLevel/dutyLogTree.action?id=0");
			tree.setOnClickHandler(doHandler)
			function doHandler(key)
			{
				var name = tree.getSelectedItemText();
		    	var id = tree.getSelectedItemId();
				window.open("${ctx}/dutyLogMessage/listDutyCalendar.action?orgid="+id,"rightFrame2");
			}
