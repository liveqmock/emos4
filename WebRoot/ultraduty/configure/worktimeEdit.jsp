	...
	<head>
		...
		<script language="javascript">
			...
			function getTime(){
				...
				showModalDialog('${ctx}/dutyConfigure/shiftTimeList.action?st.dutytypeStr='+dutytype+"&st.datetypeStr="+datetype,window,'help:no;center:true;scroll:no;status:no;dialogWidth:600px;dialogHeight:400px');
			}
		...
		<div class="content">
			<div class="title_right">
				<div class="title_left">
					<span class="title_bg"> <span class="title_icon2">班次修改</span>
					</span>
					...
					<table class="add_table">
						<tr>
							...
							<td class="add_table_right">
								...
								<input type="hidden" id="shiftTimeId" name="dutyShift.shiftTimeId" value="${dutyShift.shiftTimeId }"/>
								<input type="hidden" id="orgId" name="dutyShift.orgId" value="${dutyShift.dutyOrganization.pid }" />
						...
						<tr>
							...
							<td class="add_table_right">
								<input type="text" id="starttime" name="dutyShift.starttime" onfocus="WdatePicker({dateFmt:'HH:mm:ss',autoPickDate:true});this.className='focus'"  class="blur" readonly="readonly"
									value="${dutyShift.starttime }" style="width: 130px;"/><span class="must">*</span>
							</td>
							<td class="add_table_left">
								<span class="label">结束时间：</span>
							</td>
							<td class="add_table_right">
								<input type="text" id="endtime" name="dutyShift.endtime" onfocus="WdatePicker({dateFmt:'HH:mm:ss',autoPickDate:true});this.className='focus'"  class="blur" readonly="readonly"
									value="${dutyShift.endtime }" style="width: 130px;"/><span class="must">*</span>
							</td>
						</tr>
						<tr>
							<td class="add_table_left">
							...
							<td class="add_table_right">
								<select id="isnextday" name="dutyShift.isnextday" style="width: 130px;">
								   <option value="1" <c:if test="${dutyShift.isnextday == 1 }">selected</c:if>>是</option>
								   <option value="0" <c:if test="${dutyShift.isnextday == 0 }">selected</c:if>>否</option>
								</select>
							</td>
							<td class="add_table_left">
							...
							<td class="add_table_right">
								<select id="hideflag" name="dutyShift.hideflag" style="width: 130px;">
									<option value="0" <c:if test="${dutyShift.hideflag == 0 }">selected</c:if>>是</option>
								   <option value="1" <c:if test="${dutyShift.hideflag == 1 }">selected</c:if>>否</option>
								</select>
							</td>
						</tr>
						...
						<tr style="display: none;">
							...
							<td class="add_table_right">
								<select id="workflag" name="dutyShift.workflag" style="width: 130px;">
									<option value="1" <c:if test="${dutyShift.workflag == 1 }">selected</c:if>>是</option>
									<option value="0" <c:if test="${dutyShift.workflag == 0 }">selected</c:if>>否</option>
								</select>
							</td>
							<td class="add_table_left">
							...
							<td class="add_table_right">
								<input type="text" id="pernum" name="dutyShift.pernum" class="blur" value="${dutyShift.pernum }"
						...
						<td class="add_table_left">
							...
							<td class="add_table_right">
								<select id="isapprove" name="dutyShift.isapprove" style="width: 130px;">
									<option value="1" <c:if test="${dutyShift.isapprove == 1 }">selected</c:if>>是</option>
									<option value="0" <c:if test="${dutyShift.isapprove == 0 }">selected</c:if>>否</option>
								</select>
							</td>
							<td class="add_table_left">
							...
							<td class="add_table_right">
								<input type="text" id="orderno" name="dutyShift.orderno" class="blur" value="${dutyShift.orderno }"
									onchange="this.value=this.value.replace(/[^\d]/g,'')" style="width: 130px;"/><span class="must">*</span>
							</td>
						</tr>
						<tr>
						<!-- 
							...
							<td class="add_table_right">
								<select id="isOffConfirm" name="dutyShift.isOffConfirm" style="width: 130px;">
									<option value="1" <c:if test="${dutyShift.isOffConfirm == 1 }">selected</c:if>>是</option>
									<option value="0" <c:if test="${dutyShift.isOffConfirm == 0 }">selected</c:if>>否</option>
								</select>
							</td>
							 -->
							<td class="add_table_left">
							...
							<td class="add_table_right">
								<select id="isApproveAccept" name="dutyShift.isApproveAccept" style="width: 130px;">
									<option value="1" <c:if test="${dutyShift.isApproveAccept == 1 }">selected</c:if>>是</option>
									<option value="0" <c:if test="${dutyShift.isApproveAccept == 0 }">selected</c:if>>否</option>
								</select>
							</td>
						</tr>
					</table>
