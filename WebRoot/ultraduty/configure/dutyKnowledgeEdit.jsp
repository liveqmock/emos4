		...
		<div class="content">
			<div class="title_right">
				<div class="title_left">
					<span class="title_bg"> <span class="title_icon2">修改常识</span>
					</span>
					<span class="title_xieline"></span>
				</div>
			</div>
			<form id="form" action="saveDutyKnowledge.action" method="post" onsubmit="return Validator.Validate(this,1);">
				<input type="hidden" name="dgkInfo.pid" value="${dgkInfo.pid }"/>
				<input type="hidden" name="dgkInfo.creater" value="${dgkInfo.creater }"/>
						...
						<table class="add_table">
							<tr>
								...
								<td class="add_table_right">
									<input type="text" id="title" name="dgkInfo.title" class="textInput" maxlength="60" value="${dgkInfo.title }"/><span class="must">*</span>
							...
							<tr>
								...
								<td class="add_table_right">
									<textarea id="contents" name="dgkInfo.contents" cols="80" rows="10" style="width: 96%">${dgkInfo.contents }</textarea><span class="must">*</span>
