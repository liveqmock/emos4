  ...
  <body>
  	<div class="content">
		...
		<script type="text/javascript">
			...
			tree.setXMLAutoLoading("${ctx}/notice/getLevelTree.action");
			tree.loadXML("${ctx}/notice/getLevelTree.action?id=0&dtcode=noticeLevel");
			...
			function doHandler(key)
			{
		    	...
		    	if(id.indexOf(':')<0){
		    		...
		    		var divalue = tree.getUserData(id, "divalue");
		    		src = "${ctx}/notice/listNoticeLevel.action?noticeLevelStr="+divalue;
			...
			window.open('${ctx}/notice/listNoticeLevel.action','rightFrame2');
		</script>
  </body>
</html>
