		...
		<div id="baseInfor" class="baseInforclass">
		    ...
		    <table class="gd_table">
		      ...
		      <tr>
			    ...
			    <td class="leftalign"><eoms:select style="gd_select" name="sheetFeildsMap.province" dataDicTypeCode="provinceType" childrenname="" value="${sheetFeildsMap.province}"/></td>
		      </tr>
		      <tr>
		        <td class="rightalign"><fmt:message key="base.taskDesc" bundle="${i18Bundle}"/></td>
		        <td colspan="7" class="leftalign">
			        <div>
			            <s:textarea cssClass='gd_textare' name="sheetFeildsMap.taskDesc" rows="9" onkeydown="return txtLimit(this, 200)" onkeyup="return txtLimit(this, 200)"/>
			        </div>
		        </td>
		      </tr>
		    </table>
