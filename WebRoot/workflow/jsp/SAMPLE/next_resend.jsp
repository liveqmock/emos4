...
<script>
	...
	<table class="gd_table">
		<tr>
			...
			<td class="leftalign"><eoms:select style="gd_select" name="modLogMap.isFatalFail" dataDicTypeCode="isdefault"/></td>
		</tr>
		<tr>
			<td class="rightalign"><fmt:message key="step.reSendReason" bundle="${i18Bundle}"/></td>
			<td class="leftalign"><textarea rows="3" name="modLogMap.reSendDesc" class="gd_textare" onkeydown="return txtLimit(this, 200)" onkeyup="return txtLimit(this, 200)"></textarea></td>
		</tr>
		<tr>
			...
			<td class="leftalign mustedit"><eoms:actor hiddenId="actorStr" textId="actorName" require="true" cssClass="gd_input2" resourceBundle='${i18Bundle}' msg="step.common.validate.dealActor"/></td>
		</tr>
	</table>
	<p class="button_bar">
