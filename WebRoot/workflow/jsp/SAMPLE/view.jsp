		...
		<div id="baseInfor" class="baseInforclass">
			...
			<table class="gd_baseinfor">
			  ...
			  <tr>
			    ...
			    <td class="leftalign"><eoms:dic name="sheetFeildsMap.province" value="${sheetFeildsMap.province}" dictype="provinceType" cssClass="gd_input" type="field"/></td>
			  </tr>
			  <tr>
			    <td class="require"><fmt:message key="base.city" bundle="${i18Bundle}"/></td>
			    <td class="leftalign"><eoms:dic name="sheetFeildsMap.city" value="${sheetFeildsMap.city}" dictype="provinceType" cssClass="gd_input" type="field"/></td>
			    <td class="require"><fmt:message key="base.netName" bundle="${i18Bundle}"/></td>
			    <td class="leftalign"><s:textfield type="text" name="sheetFeildsMap.netDevice" cssClass="gd_input" maxlength="50" readonly="true"/></td>
			    <td class="require"><fmt:message key="base.dealTime" bundle="${i18Bundle}"/></td>
			    <td class="leftalign"><eoms:dateTime name="sheetFeildsMap.baseDealOutTime" value="${sheetFeildsMap.baseDealOutTime}" cssClass="gd_input" type="display"/></td>
			    <td class="require"><fmt:message key="base.acceptTime" bundle="${i18Bundle}"/></td>
			    <td class="leftalign"><eoms:dateTime name="sheetFeildsMap.baseAcceptOutTime" value="${sheetFeildsMap.baseAcceptOutTime}" cssClass="gd_input" type="display"/></td>
			  </tr>
			  <tr>
			    <td class="rightalign"><fmt:message key="base.isPreDeal" bundle="${i18Bundle}"/></td>
			    <td class="leftalign mustedit"><eoms:dic name="sheetFeildsMap.isPreDeal" value="${sheetFeildsMap.isPreDeal}" dictype="isdefault" cssClass="gd_input" type="field"/></td>
			    <td class="require"><fmt:message key="base.person" bundle="${i18Bundle}"/></td>
			    <td class="leftalign"><s:textfield name="sheetFeildsMap.contactPerson" cssClass="gd_input" maxlength="50" readonly="true"/></td>
			    <td class="require"><fmt:message key="base.connectWay" bundle="${i18Bundle}"/></td>
			    <td class="leftalign"><s:textfield name="sheetFeildsMap.contactWay" cssClass="gd_input" maxlength="50" readonly="true"/></td>
			    <td></td><td></td>
			  </tr>
			</table>
			...
			<table class="gd_table">
			  <tr>
			    ...
			    <td colspan="5" class="leftalign mustedit"><div>
			        <s:textarea cssClass='gd_textare' name="sheetFeildsMap.taskDesc" readonly="true" rows="3"/>
			      </div></td>
			  </tr>
			  <tr>
			    <td class="rightalign"><fmt:message key="base.terminate" bundle="${i18Bundle}"/></td>
			    <td class="leftalign" colspan="5"><div>
			        <s:textarea cssClass='gd_textare' name="sheetFeildsMap.termDesc" readonly="true" rows="3"/>
			      </div></td>
			  </tr>
			  <tr>
			    <td class="rightalign"><fmt:message key="base.attach" bundle="${i18Bundle}"/></td>
			    <td class="leftalign" colspan=5>
			    	<div class="fujainstyele"><atta:fileupload id="myfileupload${sheetFeildsMap.baseAttachGUID}" 
									fileTypes="*.*" 
			...
			<table class="gd_table">
			  <tr>
			    ...
			    <td class="leftalign1"><div class="newmaioshu">
			        <s:textarea id="editor1" cssClass='editor1class' name="sheetFeildsMap.richText" readonly="true"></s:textarea>
			      </div></td>
			  </tr>
			</table>
		  </div>
