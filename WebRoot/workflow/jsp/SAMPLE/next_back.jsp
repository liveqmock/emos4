...
<script>
	...
	<table class="gd_table">
		<tr>
			<td class="rightalign"><fmt:message key='step.rollbackDesc' bundle='${i18Bundle}'/></td>
			<td class="leftalign"><textarea rows="3" name="modLogMap.backDesc" class="gd_textare" onkeydown="return txtLimit(this, 200)" onkeyup="return txtLimit(this, 200)"></textarea></td>
		</tr>
	</table>
	<p class="button_bar">
