...
<script>
	...
	<table class="gd_table">
		<tr>
			<td class="rightalign"><fmt:message key="step.orgDesc" bundle="${i18Bundle}"/></td>
			<td class="leftalign"><textarea rows="3" name="modLogMap.orgauditDesc" class="gd_textare" onkeydown="return txtLimit(this, 200)" onkeyup="return txtLimit(this, 200)"></textarea></td>
		</tr>
