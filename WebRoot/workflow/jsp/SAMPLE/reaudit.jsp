...
<script>
	...
	<table class="gd_table">
		<tr>
			<td class="rightalign"><fmt:message key="step.reAuditDesc" bundle="${i18Bundle}"/></td>
			<td class="leftalign"><textarea rows="3" name="modLogMap.reauditDesc" class="gd_textare" onkeydown="return txtLimit(this, 200)" onkeyup="return txtLimit(this, 200)"></textarea></td>
		</tr>
		<s:if test="wfAction.needActor">
			<tr>
				...
				<td class="leftalign mustedit"><eoms:actor hiddenId="actorStr" textId="actorName" require="true" cssClass="gd_input2" resourceBundle='${i18Bundle}' msg="step.common.validate.auditActor"/></td>
			</tr>
		</s:if>
	</table>
	<p class="button_bar">
