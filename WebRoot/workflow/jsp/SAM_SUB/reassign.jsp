...
<script>
	...
	<table class="gd_table">
		<tr>
			<td class="rightalign"><fmt:message key="step.reAssignDesc" bundle="${i18Bundle}"/></td>
			<td class="leftalign mustedit"><textarea rows="3" name="modLogMap.reassignDesc" class="gd_textare" onkeydown="return txtLimit(this, 200)" onkeyup="return txtLimit(this, 200)"></textarea></td>
		</tr>
