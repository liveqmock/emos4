		  ...
		  */
		   ...
		   */
		   ...
		   /**
			 * 上传附件
			 */
			 function uploadAttach(baseSchema,baseId){
			 	var src = '${ctx}/tempAttachment/uploadAttatch.action?baseSchema='+baseSchema+'&baseID='+baseId;
  ...
  <body style="background-color:white;">
	    ...
	    <dg:gridtitle>
		    	<tr>
		    		...
		    		<th width="10%">跟踪</th>
		    		<c:if test="${fn:indexOf(userSession.roleName,'发布后台管理组') == -1}">    
		...
		<dg:gridrow>
			<tr class="${waitingdealsheet_row}">
    			...
    			<c:if test="${fn:indexOf(userSession.roleName,'发布后台管理组') > -1}"> 
    			<td>
    			<input type="button" onclick="uploadAttach('${baseschema}','${baseid}');"  value="上传附件" />
    			</td>
    			</c:if>   
		    </tr>
		</dg:gridrow>
