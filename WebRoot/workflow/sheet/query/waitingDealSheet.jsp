  ...
  <body style="background-color:white;">
	  	<dg:datagrid  var="waitingdealsheet"   title="${nodePath}" action="" sqlname="${queryname}" tquery="workSheetTitle">
		     ...
		     <!--
		      ...
		      -->
			  <eoms:operate cssclass="page_excel_button" id="com_btn_excel" onmouseover="this.className='page_excel_button_hover'" onmouseout="this.className='page_excel_button'" onclick="excelExport('SQL_WF_WaitingDealSheet.query','${wfSortId}','${baseSchema}')" text="com_btn_export"/>
  			</dg:lefttoolbar>
	  	<dg:condition>
		  	<div align="center">
	    ...
	    <dg:gridtitle>
		    	<tr>
		    		<th width="9%" field="serialnum"><eoms:lable name="wf_sheet_serialnum"/></th>
		    		<th width="" field="basesummary">主题</th>
		    		<th width="15%" field="dealer"><eoms:lable name="wf_sheet_dearuser"/></th>
		    		...
		    		<th width="8%" field="entryState"><eoms:lable name="wf_sheet_currentstatus"/></th>
		    		<th width="10%">跟踪</th>
		    	</tr>
	    </dg:gridtitle> 
		<dg:gridrow>
			<tr class="${viplevel eq '' ? '' : 'vip'}">
		        ...
		        <td class="over_ellipsis"><a title="${basesummary}" href="javascript:;" onclick="openSheet('${baseschema}','${baseid}','${taskid}','${processtype}');">${basesummary}</a></td>
		        <td style="text-align:center;"><a title="${deal}" href="javascript:;" onclick="openSheet('${baseschema}','${baseid}','${taskid}','${processtype}');">${deal }</td>
		        <td style="text-align:center;"><a href="javascript:;" onclick="openSheet('${baseschema}','${baseid}','${taskid}','${processtype}');"><eoms:date value="${duedate}"/></a></td>
