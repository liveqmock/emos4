  ...
  <head> 
	...
	$(function() {
		...
		$("#cdbDealTeamName").autocomplete($ctx+"/depManager/autoSearchExOutHtml.action", {
			...
			document.getElementsByName('cdbDealTeamId')[0].value = row[1];
		});	
...
// 		  }
  ...
  <body style="background-color:white;">
	  	<dg:datagrid  var="waitingdealsheet"   title="${nodePath}" action="" sqlname="SQL_WF_SQIncident.query" tquery="workSheetTitle">
	  		<dg:lefttoolbar>
	  		  ...
	  		  <eoms:operate cssclass="page_saves_button" id="page_saves_button" onmouseover="this.className='page_saves_button_hover'" onmouseout="this.className='page_saves_button'"  onclick="showsearchcondition('${ctx}','SQL_WF_SQIncident.query')" text="com_btn_config" />
  			  ...
  			  <eoms:operate cssclass="page_excel_button" id="com_btn_excel" onmouseover="this.className='page_excel_button_hover'" onmouseout="this.className='page_excel_button'" onclick="excelExport('SQL_WF_SQIncident.query','${wfSortId}','${baseSchema}')" text="com_btn_export"/>
  			</dg:lefttoolbar>
	  	<dg:condition>
		  	<div align="center">
		      <table  class="serachdivTable" style="width:80%">
		        <tr>
		          <td colspan="6" align="center">
		        	...
		        	<input type="button" name=saveCondition id="saveCondition"  class="searchButton" onmouseover="this.className='searchButton_hover'" onmouseout="this.className='searchButton'" onclick="saveConditions('incident')" value="收藏 "/>
		        	<input type="button" name=defaultCondition id="defaultCondition"  class="searchButton" onmouseover="this.className='searchButton_hover'" onmouseout="this.className='searchButton'" onclick="setConditions('incident','${userSession.pid}')" value="提取 "/>
		          </td>
		        </tr>
		      </table>
			</div>
