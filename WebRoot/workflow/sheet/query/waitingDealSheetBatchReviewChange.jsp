...
<html>
		   ...
		   */
		   ...
		   function batchReview(){
			   ...
			   var objs = document.getElementsByName("checkid");
				...
				window.open(src,'_blank','width=1000,height=660,top=50,left=300,Location=no,Toolbar=no,Resizable=no,scrollbars=yes,alwaysRaised=yes');
		   }
  ...
  <body style="background-color:white;">
	  	<dg:datagrid  var="waitingdealsheet"   title="${nodePath}" action="" sqlname="SQL_WF_WaitingDealSheet_BatchReviewChange.query" tquery="workSheetTitle">
	  		<dg:lefttoolbar>
