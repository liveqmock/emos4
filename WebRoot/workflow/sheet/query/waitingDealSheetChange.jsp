...
<html>
  ...
  <body style="background-color:white;">
	    ...
	    <dg:gridtitle>
		    	<tr>
		    		<th width="11%" field="serialnum"><eoms:lable name="wf_sheet_serialnum"/></th>
		    		<th width="20%" field="worksheettitle">主题</th>
		    		<th width="10%">变更分类</th>
		    		<th width="10%">变更类型</th>
		    		<th width="4%">变更状态</th>
		    		<th width="6%" field="dealer"><eoms:lable name="wf_sheet_dearuser"/></th>
		    		<th width="6%" field="duedate"><eoms:lable name="wf_sheet_dealtime"/></th>
		    		<th width="13%" field="createtime"><eoms:lable name="wf_sheet_stdate"/></th>
		    		<th width="5%" field="entryState"><eoms:lable name="wf_sheet_currentstatus"/></th>
		    		<th width="9%">跟踪</th>
