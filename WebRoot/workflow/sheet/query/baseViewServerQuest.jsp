...
<html>
  ...
  <body style="background-color:white;">
	  	<dg:datagrid  var="waitingdealsheet"   title="${nodePath}" action="" sqlname="SQL_WF_BaseViewServerQuest.query" tquery="workSheetTitle">
	  		<dg:lefttoolbar>
	  		  ...
	  		  <eoms:operate cssclass="page_saves_button" id="page_saves_button" onmouseover="this.className='page_saves_button_hover'" onmouseout="this.className='page_saves_button'"  onclick="showsearchcondition('${ctx}','SQL_WF_BaseViewAll.query')" text="com_btn_config" />
	    ...
	    <dg:gridtitle>
		    	<tr>
		    		<th width="12%" field="basesn"><eoms:lable name="wf_sheet_serialnum"/></th>
		    		<th width="18%" field="basesummary">主题</th>
