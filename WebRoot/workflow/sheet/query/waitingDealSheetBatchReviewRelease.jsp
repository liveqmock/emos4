...
<html>
		   ...
		   */
		   ...
		   function batchReview(){
			   ...
			   var objs = document.getElementsByName("checkid");
				...
				var src = '${ctx}/sheet/batchReview.action?baseIds='+wfString+'&baseSchema='+baseSchema;
				window.open(src,'_blank','width=1000,height=500,top=50,left=300,Location=no,Toolbar=no,Resizable=no,scrollbars=no,alwaysRaised=yes');
		   }
  ...
  <body style="background-color:white;">
	  	<dg:datagrid  var="waitingdealsheet"   title="${nodePath}" action="" sqlname="SQL_WF_WaitingDealSheet_BatchReviewRelease.query" tquery="workSheetTitle">
	  		<dg:lefttoolbar>
		     ...
		     <!--
		      ...
		      -->
			  <eoms:operate cssclass="page_batchReview_buttion" id="com_btn_batchReview" onmouseover="this.className='page_batchReview_buttion_hover'" onmouseout="this.className='page_batchReview_buttion'" onclick="batchReview()" text="com_btn_batchReview"/>
  			</dg:lefttoolbar>
	  	<dg:condition>
		  	<div align="center">
	    ...
	    <dg:gridtitle>
		    	<tr>
		    		...
		    		<th width="20%" field="serialnum"><eoms:lable name="wf_sheet_serialnum"/></th>
		    		<th width="30%" field="dealer"><eoms:lable name="wf_sheet_dearuser"/></th>
		...
		<dg:gridrow>
			<tr class="${waitingdealsheet_row}">
				<td><input name="checkid" type="checkbox" value='${baseid}'></input></td>
