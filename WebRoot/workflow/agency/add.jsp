...
<div class="content">
		...
		<div class="scroll_div" id="center">
					    ...
					    <s:form action="save.action" theme="simple" id="agencyForm" method="post" target="_self">
					    	<s:hidden name="agency.id" id="agency.id"></s:hidden>
					    	<s:hidden name="agency.dealerId" id="agency.dealerId"></s:hidden>
					    	<s:hidden name="agency.agentId" id="agency.agentId"></s:hidden>
					    	<s:hidden name="agency.createTime" id="agency.createTime"></s:hidden>
						
							<div class="tabContent_top">
								<table class="add_user" style="height: 320px">
									<tr>
										<td class="texttd">
											<eoms:lable name="wf_agency_dealname" />：
										</td>
										<td>
											<s:textfield name="agency.dealer" id="agency.dealer" cssStyle="width:80%" readonly="true"></s:textfield><input type="button" value="选择" onclick="openActorTree('agency.dealerId', 'agency.dealer')"/>
										</td>
									</tr>
									<tr>
										<td class="texttd">
									...
									<tr>
										...
										<td>
											<s:textfield name="agency.bgDateStr" id="agency_bgDate" cssStyle="width:80%" readonly="true" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'});"></s:textfield>
										</td>
									</tr>
									<tr>
										<td class="texttd">
										...
										<td>
											<s:textfield name="agency.edDateStr" id="agency_edDate" cssStyle="width:80%" readonly="true" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'});"></s:textfield>
										</td>
									</tr>
								</table>
							</div>
