...
<html>
  ...
  <body> 
  	<dg:datagrid  var="time" title="${nodePath}" action="" sqlname="SQL_OPT_WorkTimeList.query">
  		<dg:lefttoolbar>
    	...
    	<dg:gridtitle>
	    	<tr>
	    		<th><eoms:lable name="opt_lb_workCalType"/></th>
	    		<th><eoms:lable name="opt_lb_workDateStr"/></th>
	    		<th><eoms:lable name="opt_lb_startTime"/></th>
	    		<th><eoms:lable name="opt_lb_endTime"/></th>
	    		<th><eoms:lable name="opt_lb_timetype"/></th>
	    	</tr>
    	</dg:gridtitle> 
		<dg:gridrow>
			<tr class="${time_row}">
		        ...
		        <td>
			        <a href="javascript:;" onclick="openwindow('${ctx }/workCalendar/workCalendarLoad.action?id=${pid}','',800,450);">
			        	<eoms:date value="${starttime}" pattern="HH:mm"></eoms:date>
			        </a>
		        </td>
		        <td>
		        	<a href="javascript:;" onclick="openwindow('${ctx }/workCalendar/workCalendarLoad.action?id=${pid}','',800,450);">
		        		<eoms:date value="${endtime}" pattern="HH:mm"></eoms:date>
		        	</a>
		        </td>
		        <td>
		        	<a href="javascript:;" onclick="openwindow('${ctx }/workCalendar/workCalendarLoad.action?id=${pid}','',800,450);">
						<eoms:dic value="${timetype}" dictype="workTimeType"></eoms:dic>
					</a>
		        </td>
		    </tr>
		</dg:gridrow>
